...
if ($db->connect()) {
  ...
  $daoLoja = new DaoLoja($db);

  $lojas[] = new Loja("Americanas","Rua fernando correia, n987, Jd Bretania","(66) 99254-5217","94.807.252/0001-70", "78741-220");
  $lojas[] = new Loja("Submarino","Medice, n250, Jd Guarnabara","(66) 98563-5217","33.282.520/0001-93", "74523-500");

  foreach($lojas as $l) $daoLoja->inserir($l);
